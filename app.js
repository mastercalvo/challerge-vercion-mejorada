...
function validarTexto(texto) {
    // Verificar si el texto contiene solo letras minúsculas y sin acentos
    const regex = /^[a-z\s]+$/;
...
function encriptar() {
    ...
    if (!validarTexto(texto)) {
        alert("El texto ingresado no es válido. Solo se permiten letras minúsculas y sin acentos.");
        return;
    }
